...
use App\Http\Requests\Product\EditSCat;
use App\Http\Requests\Product\SaveCat;
use App\Http\Requests\Product\SaveSCat;
...
public function indexForSub(Request $r){
    ...
    $Vuedata=[
        'path'=>[
            ...
            'save.scat'=>route('product.subcategory.save'),
            'delete.scat'=>route('product.subcategory.delete'),
            'edit.scat'=>route('product.subcategory.edit'),
            ...
            'get.allCat'=>route('settings.Product.Category.all'),
            'get.allSubCat'=>route('settings.Product.SubCategory.all'),
    ...
    public function Subsave(SaveSCat $r){
    ...
    public function Subdelete(EditSCat $r){
    ...
    public function Subedit(EditSCat $r){
        $response=[];
        $input=$r->all();
        $m=new ProductCategory();
